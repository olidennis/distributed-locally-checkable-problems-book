...
& \O \s \O &
\end{flalign*}
Yes, we just replaced $\Delta$ with a $3$. The subtle difference is that we can apply round elimination on problems, not on family of problems. We will see, when discussing round elimination, why this complicates things.
